defmodule RecipesWeb.TagLive.FormComponent do
  ...
  defp save_tag(socket, :edit, tag_params) do
    case Data.update_tag(socket.assigns.tag, tag_params) do
      {:ok, tag} ->
  ...
  defp save_tag(socket, :new, tag_params) do
    case Data.create_tag(tag_params) do
      {:ok, tag} ->
        notify_parent({:saved, tag})
