defmodule RecipesWeb.CoreComponents do
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "my-1 block w-full rounded-lg text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6",
  ...
  def back(assigns) do
    ...
    <div class="mt-16">
      <.link
        navigate={@navigate}
        class="text-sm font-semibold leading-6 text-zinc-900 hover:text-zinc-700 align-middle"
      >
